...
public class IsMethodParameterAnnotatedTest {
    private static final String ANNOTATED_METHOD_NAME = "methodParameterAnnotated";
    @Test
    public void shouldMismatchIfItemIsNull() throws Exception {
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class, null, 1,
    ...
    public void shouldMismatchIfMethodMissing() throws Exception {
        ...
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class, null, 0, "notThere");
        Description description = new StringDescription();
    ...
    public void shouldMismatchIfAnnotationMissing() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class, null, 0,
                ANNOTATED_METHOD_NAME, String.class, int.class);
        Description description = new StringDescription();
    ...
    public void shouldMismatchIfTargetAnnotationIsNull() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(null, null, 1, ANNOTATED_METHOD_NAME,
    ...
    public void shouldMismatchIfParamOutOfBounds() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class, null, 4,
                ANNOTATED_METHOD_NAME, String.class, int.class);
        Description description = new StringDescription();
    ...
    public void shouldMismatchIfAnnotationParamIsMissing() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class,
                AnnotationParamMatcher.hasParam("notThere"), 1, ANNOTATED_METHOD_NAME, String.class, int.class);
        Description description = new StringDescription();
    ...
    public void shouldMismatchIfAnnotationParamValueDifferent() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class,
                AnnotationParamMatcher.hasParamValue("value", 42), 1, ANNOTATED_METHOD_NAME, String.class, int.class);
        Description description = new StringDescription();
    ...
    public void shouldMatchIfAnnotationHasParam() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class,
                AnnotationParamMatcher.hasParam("value"), 1, ANNOTATED_METHOD_NAME, String.class, int.class);
    ...
    public void shouldMatchIfAnnotationHasParamValue() throws Exception {
        TestAnnotated annotated = new TestAnnotated();
        IsMethodParameterAnnotated matcher = new IsMethodParameterAnnotated(TestAnnotation.class,
                AnnotationParamMatcher.hasParamValue("value", TestAnnotated.TEST_VALUE), 1, ANNOTATED_METHOD_NAME,
                String.class, int.class);
    ...
    public void shouldDescribeTo() throws Exception {
        ...
        assertThat(description.toString(), is("method parameter to be annotated with " +
    ...
    public void shouldMatchFactoryWith() throws Exception {
        ...
        assertThat(IsMethodParameterAnnotated.with(TestAnnotation.class, 1, ANNOTATED_METHOD_NAME, String.class,
                int.class).matches(annotated), is(true));
    }
    ...
    public void shouldMatchFactoryWithParam() throws Exception {
        ...
        assertThat(IsMethodParameterAnnotated.withParam(TestAnnotation.class, "value", 1, ANNOTATED_METHOD_NAME,
                String.class, int.class).matches(annotated),is(true));
    }
    ...
    public void shouldMatchFactoryWithParamValueUsingMatcher() throws Exception {
        ...
        assertThat(IsMethodParameterAnnotated.withParamValue(TestAnnotation.class, "value", is(56), 1,
                ANNOTATED_METHOD_NAME, String.class, int.class).matches(annotated), is(true));
    }
    ...
    public void shouldMatchFactoryWithParamValue() throws Exception {
        ...
        assertThat(IsMethodParameterAnnotated.withParamValue(TestAnnotation.class, "value", 56, 1,
                ANNOTATED_METHOD_NAME, String.class, int.class).matches(annotated), is(true));
    }
}
